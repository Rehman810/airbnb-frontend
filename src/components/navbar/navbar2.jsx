...
const NavbarHost = () => {
  ...
  const menuItems = [
    {
      name: t("menu.hostMenu.today"),
      route: "/hosting/today",
    },
    {
      name: t("menu.hostMenu.calendar"),
      route: "/hosting/calendar",
    },
    {
      name: t("menu.hostMenu.listings"),
      route: "/hosting/listings",
    },
    {
      name: t("menu.hostMenu.messages"),
      route: "/hosting/messages",
    },
  ];
            ...
            <>
              ...
              <Menu
                ...
                {[
                  {
                    name: t(
                      "menu.hostMenu2.userProfile"
                    ),
                    route: "/user/profile",
                  },
                  {
                    name: t(
                      "menu.hostMenu2.userAccount"
                    ),
                    route: "/user/account",
                  },
                  {
                    name: t(
                      "menu.hostMenu2.visitHelpCenter"
                    ),
                    route: "/help/center",
                  },
                  {
                    name: t(
                      "menu.hostMenu2.helpSafetyIssue"
                    ),
                    route: "/help/safety-issue",
                  },
                  {
                    name: t(
                      "menu.hostMenu2.giftCards"
                    ),
                ...
                <MenuItem
                  onClick={() => navigate("/")}>
                  {t(
                    "menu.hostMenu2.switchToTravelling"
                  )}
                </MenuItem>
                <MenuItem
                  onClick={() =>
